...
class AppwriteDeltaSync {
  ...
  Future<void> _applySalaryWithdrawalChange(AppDatabase db, String localUuid, Map<String, dynamic> data) async {
    ...
    final companion = SalaryWithdrawalsCompanion(
      ...
      action: d.Value(_asString(data['action']) ?? 'سحب راتب'),
      amount: d.Value(_asDouble(data['amount'])),
      note: _nullableValue<String>(_asString(data['note'])),
      date: d.Value(_asString(data['date']) ?? ''),
    );
  ...
  Future<void> _applyBookingPriceAdjustmentChange(AppDatabase db, String localUuid, Map<String, dynamic> data) async {
    final bookingLocalUuid = _asString(data['bookingLocalUuid']) ?? _asString(data['bookingUuid']);
    if (bookingLocalUuid == null || bookingLocalUuid.isEmpty) return;
    ...
    final companion = BookingPriceAdjustmentsCompanion(
      ...
      version: d.Value(_asInt(data['version']) ?? 1),
      origin: d.Value('appwrite_delta'),
      bookingLocalUuid: d.Value(bookingLocalUuid),
      bookingLocalId: _nullableValue<int>(_asInt(data['bookingLocalId'])),
      adjustmentType: d.Value(_asInt(data['adjustmentType']) ?? 0),
      adjustmentMode: d.Value(_asString(data['adjustmentMode']) ?? 'per_night'),
      amount: d.Value(_asDouble(data['amount'])),
      effectiveHotelDay: d.Value(_asString(data['effectiveHotelDay']) ?? ''),
      endHotelDay: _nullableValue<String>(_asString(data['endHotelDay'])),
      isActive: d.Value(data['isActive'] == true || data['isActive'] == 1),
      reason: _nullableValue<String>(_asString(data['reason'])),
      appliedBy: _nullableValue<String>(_asString(data['appliedBy'])),
      cancelledAt: _nullableValue<String>(_asString(data['cancelledAt'])),
      cancelledBy: _nullableValue<String>(_asString(data['cancelledBy'])),
    );
  ...
  Future<void> _applyShiftNoteChange(AppDatabase db, String localUuid, Map<String, dynamic> data) async {
  ...
  Future<void> _applyCashTransactionChange(AppDatabase db, String localUuid, Map<String, dynamic> data) async {
    final transactionType = _asString(data['transactionType']);
  ...
  Future<void> _applyBookingNightChange(AppDatabase db, String localUuid, Map<String, dynamic> data) async {
    final bookingLocalId = _asInt(data['bookingLocalId']);
    final hotelDayKey = _asString(data['hotelDayKey']);
    if (bookingLocalId == null || hotelDayKey == null) return;
    ...
    final companion = BookingNightsCompanion(
      ...
      isProcessedByAutoFix: d.Value(data['isProcessedByAutoFix'] == true || data['isProcessedByAutoFix'] == 1),
  ...
  Future<void> _applyHotelDayLedgerChange(AppDatabase db, String localUuid, Map<String, dynamic> data) async {
    final hotelDayKey = _asString(data['hotelDayKey']);
  ...
  Future<void> _applySalaryCycleChange(AppDatabase db, String localUuid, Map<String, dynamic> data) async {
    final employeeId = _asInt(data['employeeId']);
    final cycleKey = _asString(data['cycleKey']);
    if (employeeId == null || cycleKey == null) return;
  ...
  Future<void> _applySalaryPaymentChange(AppDatabase db, String localUuid, Map<String, dynamic> data) async {
    ...
    final companion = SalaryPaymentsCompanion(
      ...
      isAutoGenerated: d.Value(data['isAutoGenerated'] == true || data['isAutoGenerated'] == 1),
    );

    await db.into(db.salaryPayments).insertOnConflictUpdate(companion);
  }

  Future<void> _applyPriceAdjustmentChange(AppDatabase db, String localUuid, Map<String, dynamic> data) async {
    ...
    final companion = PriceAdjustmentsCompanion(
      ...
      roomNumber: _nullableValue<String>(_asString(data['roomNumber'])),
      isReversed: d.Value(data['isReversed'] == true || data['isReversed'] == 1),
