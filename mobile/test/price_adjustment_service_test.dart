...
void main() {
  ...
  group('تعديل السعر أثناء الإقامة', () {
    test('السيناريو: دخول يوم 5 بسعر 10000، رفع السعر يوم 10 إلى 12000',
        () async {
      ...
      for (var i = 0; i < nightDates.length; i++) {
        await db.into(db.bookingNights).insert(BookingNightsCompanion(
              ...
              nightEnd:
                  Value('${nightDates[(i + 1) % nightDates.length]}T14:00:00'),
      ...
      final updatedNights = await (db.select(db.bookingNights)
