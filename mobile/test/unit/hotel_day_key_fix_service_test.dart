...
void main() {
  ...
  group('HotelDayKeyFixService — computeCorrectHotelDayKey', () {
    ...
    test('تاريخ ISO بعد 14:01 يعود لنفس اليوم', () {
      final key = HotelDayKeyFixService.computeCorrectHotelDayKey('2025-06-15 15:00:00');
      expect(key, '2025-06-15');
    });

    test('تاريخ ISO قبل 14:01 يعود لليوم السابق', () {
      final key = HotelDayKeyFixService.computeCorrectHotelDayKey('2025-06-15 10:00:00');
      expect(key, '2025-06-14');
    });

    test('تاريخ ISO بالضبط 14:00 يعود لليوم السابق', () {
      final key = HotelDayKeyFixService.computeCorrectHotelDayKey('2025-06-15 14:00:00');
      expect(key, '2025-06-14');
    });

    test('تاريخ ISO بالضبط 14:01 يعود لنفس اليوم', () {
      final key = HotelDayKeyFixService.computeCorrectHotelDayKey('2025-06-15 14:01:00');
      expect(key, '2025-06-15');
    });

    test('تاريخ ISO بتنسيق T', () {
      final key = HotelDayKeyFixService.computeCorrectHotelDayKey('2025-06-15T15:30:00');
      expect(key, '2025-06-15');
    });

    test('تاريخ ISO بتنسيق T قبل الحد', () {
      final key = HotelDayKeyFixService.computeCorrectHotelDayKey('2025-06-15T10:00:00');
      expect(key, '2025-06-14');
    });
    ...
    test('منتصف الليل (00:00) يعود لليوم السابق', () {
      final key = HotelDayKeyFixService.computeCorrectHotelDayKey('2025-06-15 00:00:00');
      expect(key, '2025-06-14');
    });
    ...
    test('قيمة حدية: بداية سنة جديدة مع وقت مبكر', () {
      final key = HotelDayKeyFixService.computeCorrectHotelDayKey('2025-01-01 10:00:00');
