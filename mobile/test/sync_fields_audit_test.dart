...
void main() {
  ...
  test(
    'sync fields audit — every adapter.collectionId must exist in validFieldsPerCollection',
    () {
  ...
  test(
    'sync fields audit — every schema collection has required sync fields',
    () {
      final schema = AppwriteSyncUtils.validFieldsPerCollection;
      ...
      print(
        'Collections with missing fields: ${missingFieldsByCollection.length}\n',
      );
