...
void main() {
  ...
  test('hotelDayKeyFromIso trims/normalizes and falls back on parse errors', () {
    expect(Time.hotelDayKeyFromIso('2024-01-15 10:00:00', cutoffHour: 12), '2024-01-15');
  ...
  test('nightsWithCutoff counts segments across cutoff boundaries', () {
    ...
    final one = Time.nightsWithCutoff(checkin, checkout: DateTime(2024, 1, 1, 12, 0), cutoffHour: 14);
    expect(one, 1);
  });
}
