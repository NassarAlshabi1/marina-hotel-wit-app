...
void main() {
  test('hotelDayKey respects cutoff and backshifts same day before cutoff', () {
    final t =
        DateTime(2024, 1, 10, 10); // before 14:00 -> shifts to previous day
  ...
  test('hotelDayKeyFromIso trims/normalizes and falls back on parse errors',
      () {
    expect(Time.hotelDayKeyFromIso('2024-01-15 10:00:00', cutoffHour: 12),
        '2024-01-15');
    expect(Time.hotelDayKeyFromIso('2024-01-15T03:00:00', cutoffHour: 12),
        '2024-01-14');
  ...
  test('hotelDayStart and end iso helpers', () {
    ...
    expect(Time.hotelDayStartIso('2024-04-30', cutoffHour: 9),
        '2024-04-30T09:00:00');
    expect(Time.hotelDayEndIso('2024-04-30', cutoffHour: 9),
        '2024-05-01T09:00:00');
  });
  ...
  test('nightsWithCutoff counts segments across cutoff boundaries', () {
    ...
    expect(
        Time.nightsWithCutoff(checkin, checkout: checkout, cutoffHour: 14), 2);

    // checkout before checkin -> minimum 1 night
    final one = Time.nightsWithCutoff(checkin,
        checkout: DateTime(2024, 1, 1, 12, 0), cutoffHour: 14);
    expect(one, 1);
  });
}
