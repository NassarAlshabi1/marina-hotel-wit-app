...
/** Mirrors the Flutter `inventory_items` Drift table. */
@Entity(
    tableName = "inventory_items",
    indices = [
        Index(value = ["name"], name = "idx_inv_items_name"),
        Index(value = ["category"], name = "idx_inv_items_category"),
        Index(value = ["name"], name = "idx_inv_items_active"),
