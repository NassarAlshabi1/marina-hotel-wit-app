...
@Entity(
    ...
    indices = [
        Index("idx_shift_notes_created_by", "created_by"),
        Index("idx_shift_notes_date", "created_at"),
        Index("idx_shift_notes_read", "is_read"),
        Index("idx_shift_notes_priority", "priority"),
        Index("idx_shift_notes_shift_type", "shift_type")
    ]
)
