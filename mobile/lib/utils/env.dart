...
class Env {
  ...
  static const String whatsappPhoneNumber = String.fromEnvironment('WHATSAPP_PHONE_NUMBER');

  /// مفتاح API CallMeBot — يجب تمريره عبر --dart-define
  static const String whatsappApiKey = String.fromEnvironment('WHATSAPP_API_KEY');
  ...
  static const String whatsappApiToken = String.fromEnvironment('WHATSAPP_API_TOKEN');

  /// WhatsApp GreenAPI Instance ID — يجب تمريره عبر --dart-define
  static const String whatsappInstanceId = String.fromEnvironment('WHATSAPP_INSTANCE_ID');
  ...
  static const String hotelContactPhone = String.fromEnvironment('HOTEL_CONTACT_PHONE');
  ...
  static const String agentRouterApiKey = String.fromEnvironment('AGENT_ROUTER_API_KEY');
  ...
  static bool get isTelegramConfigured => telegramBotToken.isNotEmpty && telegramChatId.isNotEmpty;

  /// هل تم تكوين WhatsApp CallMeBot؟
  static bool get isWhatsAppCallMeBotConfigured => whatsappPhoneNumber.isNotEmpty && whatsappApiKey.isNotEmpty;

  /// هل تم تكوين WhatsApp GreenAPI؟
  static bool get isWhatsAppGreenApiConfigured => whatsappApiToken.isNotEmpty && whatsappInstanceId.isNotEmpty;
