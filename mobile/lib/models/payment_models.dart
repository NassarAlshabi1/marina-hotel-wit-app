...
class Invoice {
  ...
  List<pw.Widget> _buildInvoiceContent(
    ArabicPdfFonts fonts,
        ...
        children: [
          pw.Expanded(
            child: _buildInfoCard(
              ...
              rows: [
                ('الاسم', guestName),
                ('الهاتف', guestPhone.isEmpty ? '—' : guestPhone),
                ('الغرفة', roomNumber),
              ],
            ),
          ),
              ...
              children: [
                ...
                pw.Text(
                  ...
                  style: pw.TextStyle(
                    font: fonts.regular,
                    fontSize: 9,
                    color: const PdfColor(0.8, 0.88, 0.95),
                  ),
                ),
              ],
            ),
          ...
          ...rows.asMap().entries.map(
            (entry) => pw.Padding(
              padding: pw.EdgeInsets.only(
                bottom: entry.key == rows.length - 1 ? 0 : 5,
              ),
              child: pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
          ...
          ...sortedPayments.asMap().entries.map((entry) {
            ...
            return pw.TableRow(
              ...
              children: [
                ...
                _tableCell(
                  fonts,
                  '${EnhancedPdfUtils.formatNumber(p.amount)} ريال',
                  bold: true,
                  center: true,
                ),
                _tableCell(
          ...
          pw.Container(
            ...
            decoration: pw.BoxDecoration(
              color: remainingAmount > 0
                  ...
                  : const PdfColor(0.92, 0.98, 0.93),
              borderRadius: pw.BorderRadius.circular(6),
              border: pw.Border.all(
                color: remainingAmount > 0 ? _cRed : _cGreen,
                width: 0.5,
              ),
            ),
            child: pw.Row(
