...
ArabicPdfFonts? _cachedArabicFonts;
Future<ArabicPdfFonts>? _cachedArabicFontsFuture;

Future<ArabicPdfFonts> _ensureArabicFonts() async {
  if (_cachedArabicFonts != null) {
    return _cachedArabicFonts!;
  }
  _cachedArabicFontsFuture ??= PdfUtils.loadArabicFonts();
  _cachedArabicFonts = await _cachedArabicFontsFuture!;
  return _cachedArabicFonts!;
}
...
class Receipt {
  ...
  Future<void> generatePDF() async {
    final fonts = await _ensureArabicFonts();
              ...
              children: [
                ...
                ...payments.map((payment) => pw.TableRow(
                      children: [
                        ...
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(6),
                          child: pw.Text(payment.method.displayName,
                              style: const pw.TextStyle(fontSize: 10)),
                        ),
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(6),
            ...
            children: [
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text(
                      '${(totalAmount - remainingAmount).toStringAsFixed(2)}',
                      style: pw.TextStyle(fontSize: 14)),
                ],
              ),
