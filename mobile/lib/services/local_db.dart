...
class SalaryPayments extends Table with SyncFields {
  ...
  BoolColumn get isAutoGenerated =>
      boolean().withDefault(const Constant(false))();
  // ✅ حقول موجودة في Appwrite Cloud — كانت ناقصة من الجدول المحلي
...
class AppDatabase extends _$AppDatabase {
  ...
  MigrationStrategy get migration => MigrationStrategy(
    ...
    onUpgrade: (m, from, to) async {
      ...
      // ✅ Migration 41: إضافة employeeId, paymentDate, notes إلى salary_payments
      if (from < 41) {
        await m.addColumn(salaryPayments, salaryPayments.employeeId);
        await m.addColumn(salaryPayments, salaryPayments.paymentDate);
