...
class AppwriteDeltaSync {
  ...
  static final _allowedFields = <String, Set<String>>{
    ...
    'booking_nights': {'bookingLocalId', 'hotelDayKey', 'nightStart', 'nightEnd', 'nightlyRate', 'sequence', 'isProcessedByAutoFix'},
    'employees': {'name', 'basicSalary', 'position', 'phone', 'hireDate', 'status'},
    'expenses': {'expenseType', 'relatedId', 'description', 'amount', 'date', 'cashTransactionId', 'hotelDayKey', 'categoryUuid', 'cashFlowUuid', 'isAutoGenerated'},
    'cash_transactions': {'transactionType', 'amount', 'transactionTime', 'registerId', 'referenceType', 'referenceId', 'description', 'createdBy'},
    'payments': {'bookingId', 'bookingUuid', 'amount', 'method', 'notes', 'paymentTime', 'hotelDayKey', 'cashTransactionId', 'receiptNumber', 'isImmutable', 'isVoided', 'voidedAt', 'voidedBy'},
    'debts': {'bookingId', 'bookingUuid', 'guestName', 'roomNumber', 'amount', 'paidAmount', 'remainingAmount', 'status', 'checkoutDate', 'paymentDeadline', 'notes', 'contactPhone', 'settledAt', 'settledByPaymentId', 'hotelDayKey'},
    'hotel_day_ledger': {'hotelDayKey', 'totalIncome', 'totalExpenses', 'pendingBalances', 'occupancyRate', 'bookingsProcessed', 'paymentsProcessed', 'debtsProcessed', 'expensesProcessed', 'status'},
    'shift_notes': {'noteText', 'category', 'hotelDayKey', 'shiftType', 'authorName', 'isImportant', 'isRead'},
    'salary_cycles': {'employeeId', 'cycleKey', 'expectedAmount', 'actualPaid', 'remainingAmount', 'status', 'startDate', 'endDate', 'closedAt'},
    'salary_payments': {'employeeId', 'salaryCycleId', 'amount', 'paymentDate', 'hotelDayKey', 'notes', 'paymentMethod', 'cashTransactionId'},
    'price_adjustments': {'targetType', 'targetUuid', 'adjustmentType', 'previousValue', 'newValue', 'reason', 'effectiveDate', 'appliedBy', 'hotelDayKey', 'isReversed', 'reversedAt', 'reversedBy'},
    'booking_price_adjustments': {'bookingLocalUuid', 'bookingLocalId', 'adjustmentType', 'adjustmentMode', 'amount', 'effectiveHotelDay', 'endHotelDay', 'isActive', 'reason', 'appliedBy', 'cancelledAt', 'cancelledBy'},
    'audit_logs': {'operationType', 'entityType', 'entityUuid', 'entityId', 'previousState', 'newState', 'changedFields', 'performedBy', 'ipAddress', 'hotelDayKey', 'timestamp', 'timestampIso', 'isFinancial', 'amountImpact'},
    'payment_voids': {'originalPaymentUuid', 'originalPaymentId', 'bookingUuid', 'voidedAmount', 'voidReason', 'voidedBy', 'voidedAt', 'voidedAtIso', 'hotelDayKey', 'reversalPaymentUuid', 'approvedBy'},
  };
