...
class SalaryAdvanceInstallmentsService {
  ...
  Future<void> createInstallmentAdvance({
    ...
    final effectiveDescription =
        description.trim().isNotEmpty ? description.trim() : ExpenseTypes.salaryAdvance;

    await _db.transaction(() async {
      final advanceExpenseId = await _expensesRepo.createAutoGenerated(
        expenseType: ExpenseTypes.salaryAdvance,
      ...
      await _salaryWithdrawalsRepo.saveFromExpense(
        ...
        action: ExpenseTypes.salaryAdvance,
        amount: totalAmount,
        date: date,
      ...
      for (var i = 1; i <= installments; i++) {
        ...
        final exists = await (_db.select(_db.expenses)
              ...
              ..where((e) => e.expenseType.equals(ExpenseTypes.salaryDeduction))
        ...
        final installmentExpenseId = await _expensesRepo.createAutoGenerated(
          expenseType: ExpenseTypes.salaryDeduction,
          relatedId: employeeId,
        ...
        await _salaryWithdrawalsRepo.saveFromExpense(
          ...
          employeeId: employeeId,
          action: ExpenseTypes.salaryDeduction,
          amount: -amt,
          date: dueStr,
          note: instDesc,
          hotelDayKey: HotelTimeEngine.getHotelDayKey(),
