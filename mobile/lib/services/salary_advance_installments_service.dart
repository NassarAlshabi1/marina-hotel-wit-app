...
class SalaryAdvanceInstallmentsService {
  SalaryAdvanceInstallmentsService(this._db, this._expensesRepo, this._salaryWithdrawalsRepo);
  ...
  Future<void> createInstallmentAdvance({
    ...
    final effectiveDescription = description.trim().isNotEmpty ? description.trim() : 'سلفة';
