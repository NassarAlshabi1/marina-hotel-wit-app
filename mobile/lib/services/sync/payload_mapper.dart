...
class PayloadMapper {
  ...
  Map<String, dynamic> roomToRemote(Room room) {
    ...
    putIfStringNotEmpty(data, 'lastOccupiedHotelDay', room.lastOccupiedHotelDay);
    putIfNotNull(data, 'requiresMaintenance', room.requiresMaintenance);
    // TODO: enable when Drift model has this field — putIfStringNotEmpty(data, 'idempotencyKey', room.idempotencyKey);
  ...
  Map<String, dynamic> bookingToRemote(Booking booking) {
    ...
    // TODO: enable when Drift model has this field — putIfStringNotEmpty(data, 'idempotencyKey', booking.idempotencyKey);
  ...
  Map<String, dynamic> expenseToRemote(Expense expense) {
    ...
    // حقول v2 الجديدة
    // TODO: enable when Drift model has this field — putIfStringNotEmpty(data, 'employeeUuid', expense.employeeUuid);
    // TODO: enable when Drift model has this field — putIfStringNotEmpty(data, 'idempotencyKey', expense.idempotencyKey);
  ...
  Map<String, dynamic> paymentToRemote(Payment payment) {
    ...
    // TODO: enable when Drift model has this field — putIfStringNotEmpty(data, 'idempotencyKey', payment.idempotencyKey);
  ...
  Map<String, dynamic> debtToRemote(Debt debt) {
    ...
    // TODO: enable when Drift model has this field — putIfStringNotEmpty(data, 'idempotencyKey', debt.idempotencyKey);
  ...
  Map<String, dynamic> employeeToRemote(Employee employee) {
    ...
    // TODO: enable when Drift model has this field — putIfStringNotEmpty(data, 'idempotencyKey', employee.idempotencyKey);
  ...
  Map<String, dynamic> bookingNoteToRemote(BookingNote note) {
    ...
    // TODO: enable when Drift model has this field — putIfStringNotEmpty(data, 'idempotencyKey', note.idempotencyKey);
    return data;
  }
  ...
  Map<String, dynamic> bookingNightToRemote(BookingNight night) {
    ...
    // TODO: enable when Drift model has this field — putIfStringNotEmpty(data, 'idempotencyKey', night.idempotencyKey);
  ...
  Map<String, dynamic> cashTransactionToRemote(CashTransaction transaction) {
    ...
    // TODO: enable when Drift model has this field — putIfStringNotEmpty(data, 'idempotencyKey', transaction.idempotencyKey);
    return data;
  }
  ...
  Map<String, dynamic> salaryCycleToRemote(SalaryCycle cycle) {
    ...
    // TODO: enable when Drift model has this field — putIfStringNotEmpty(data, 'idempotencyKey', cycle.idempotencyKey);
    return data;
  }
  ...
  Map<String, dynamic> priceAdjustmentToRemote(PriceAdjustment row) {
    ...
    return {
      ...
      // TODO: enable when Drift model has this field — if (row.idempotencyKey != null) 'idempotencyKey': row.idempotencyKey,
    };
  }
  ...
  Map<String, dynamic> blacklistToRemote(ShiftNote item) {
    ...
    return {
      ...
      // TODO: enable when Drift model has this field — if (item.idempotencyKey != null) 'idempotencyKey': item.idempotencyKey,
    };
  }
  ...
  Map<String, dynamic> salaryWithdrawalToRemote(
    ...
    // TODO: enable when Drift model has this field — putIfStringNotEmpty(data, 'idempotencyKey', withdrawal.idempotencyKey);
  ...
  Map<String, dynamic> bookingPriceAdjustmentToRemote(BookingPriceAdjustment adj) {
    ...
    // TODO: enable when Drift model has this field — putIfStringNotEmpty(data, 'idempotencyKey', adj.idempotencyKey);
  ...
  Map<String, dynamic> salaryCarryOverLogToRemote(SalaryCarryOverLog log) {
    ...
    // TODO: enable when Drift model has this field — putIfStringNotEmpty(data, 'idempotencyKey', log.idempotencyKey);
