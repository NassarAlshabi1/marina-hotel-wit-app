...
class SyncService {
    ...
    switch (entity) {
      ...
      case 'booking_notes':
        ...
        if (rowN != null) {
          await (db.update(
            db.bookingNotes,
          )..where((t) => t.id.equals(rowN.id))).write(
      ...
      case 'employees':
        ...
        if (rowE != null) {
          await (db.update(
            db.employees,
          )..where((t) => t.id.equals(rowE.id))).write(
            EmployeesCompanion(
              serverId: d.Value(sid),
              lastModified: d.Value(Time.nowEpoch()),
            ),
      ...
      case 'expenses':
        ...
        if (rowX != null) {
          await (db.update(
            db.expenses,
          )..where((t) => t.id.equals(rowX.id))).write(
            ExpensesCompanion(
              serverId: d.Value(sid),
              lastModified: d.Value(Time.nowEpoch()),
            ),
      ...
      case 'cash_transactions':
        ...
        if (rowC != null) {
          await (db.update(
            db.cashTransactions,
          )..where((t) => t.id.equals(rowC.id))).write(
      ...
      case 'payments':
        ...
        if (rowP != null) {
          await (db.update(
            db.payments,
          )..where((t) => t.id.equals(rowP.id))).write(
            PaymentsCompanion(
    ...
    switch (entity) {
      ...
      case 'bookings':
        ...
        if (sbid != null) {
          local = await (db.select(
            db.bookings,
          )..where((t) => t.serverBookingId.equals(sbid))).getSingleOrNull();
        }
      ...
      case 'booking_notes':
        ...
        if (nid != null) {
          ln = await (db.select(
            db.bookingNotes,
          )..where((t) => t.serverId.equals(nid))).getSingleOrNull();
        }
        if (ln != null) {
          if (serverTs >= ln.lastModified) {
            await notesDao.updateById(
              ...
              BookingNotesCompanion(
                ...
                alertType: d.Value(
                  data['alert_type'] as String? ?? ln.alertType,
                ),
        ...
        if (op == 'delete' || data['deleted_at'] != null) {
          final target =
              ...
              await (db.select(
                db.bookingNotes,
              )..where((t) => t.serverId.equals(nid ?? -1))).getSingleOrNull();
          if (target != null) {
      ...
      case 'employees':
        ...
        if (sid != null) {
          le = await (db.select(
            db.employees,
          )..where((t) => t.serverId.equals(sid))).getSingleOrNull();
        }
        if (le != null) {
        ...
        if (op == 'delete' || data['deleted_at'] != null) {
          final target =
              ...
              await (db.select(
                db.employees,
              )..where((t) => t.serverId.equals(sid ?? -1))).getSingleOrNull();
          if (target != null) {
      ...
      case 'expenses':
        ...
        if (xid != null) {
          lx = await (db.select(
            db.expenses,
          )..where((t) => t.serverId.equals(xid))).getSingleOrNull();
        }
        if (lx != null) {
          if (serverTs >= lx.lastModified) {
            await expensesDao.updateById(
              ...
              ExpensesCompanion(
                expenseType: d.Value(
                  data['expense_type'] as String? ?? lx.expenseType,
                ),
                relatedId: d.Value((data['related_id'] as num?)?.toInt()),
                description: d.Value(
                  data['description'] as String? ?? lx.description,
                ),
                amount: d.Value(
          ...
          await expensesDao.insertOne(
            ExpensesCompanion(
              ...
              date: d.Value(
                data['date'] as String? ??
                    Time.safeIsoToDateString(Time.nowIso()),
              ),
              serverId: d.Value(xid),
            ),
            originIsServer: true,
        ...
        if (op == 'delete' || data['deleted_at'] != null) {
          final target =
              ...
              await (db.select(
                db.expenses,
              )..where((t) => t.serverId.equals(xid ?? -1))).getSingleOrNull();
          if (target != null) {
      ...
      case 'cash_transactions':
        ...
        final lc = cid != null
            ? await (db.select(
                db.cashTransactions,
              )..where((t) => t.serverId.equals(cid))).getSingleOrNull()
            : null;
        if (lc != null) {
          ...
          await cashDao.insertOne(
            CashTransactionsCompanion(
              registerId: d.Value((data['register_id'] as num?)?.toInt()),
              transactionType: d.Value(
                data['transaction_type'] as String? ?? 'income',
              ),
              amount: d.Value((data['amount'] as num?)?.toDouble() ?? 0),
              referenceType: d.Value(data['reference_type'] as String?),
              referenceId: d.Value((data['reference_id'] as num?)?.toInt()),
        ...
        if (op == 'delete' || data['deleted_at'] != null) {
          final target =
              ...
              await (db.select(
                db.cashTransactions,
              )..where((t) => t.serverId.equals(cid ?? -1))).getSingleOrNull();
          if (target != null) {
      ...
      case 'payments':
        ...
        final lp = pid != null
            ? await (db.select(
                db.payments,
              )..where((t) => t.serverPaymentId.equals(pid))).getSingleOrNull()
            : null;
        if (lp != null) {
          if (serverTs >= lp.lastModified) {
            await paymentsDao.updateById(
              ...
              PaymentsCompanion(
                ...
                paymentDate: d.Value(
                  data['payment_date'] as String? ?? lp.paymentDate,
                ),
                notes: d.Value(data['notes'] as String?),
                ...
                revenueType: d.Value(
                  data['revenue_type'] as String? ?? lp.revenueType,
                ),
          ...
          await paymentsDao.insertOne(
            PaymentsCompanion(
              ...
              amount: d.Value((data['amount'] as num?)?.toDouble() ?? 0),
              paymentDate: d.Value(
                data['payment_date'] as String? ?? Time.nowIso(),
              ),
              notes: d.Value(data['notes'] as String?),
              paymentMethod: d.Value(
                data['payment_method'] as String? ?? 'نقدي',
              ),
  ...
  Future<void> _applyBookingNight(
    String op,
    int serverTs,
    Map<String, dynamic> data,
  ) async {
...
String _secondsToIso(int seconds) => DateTime.fromMillisecondsSinceEpoch(
  seconds * 1000,
  isUtc: true,
).toIso8601String();
