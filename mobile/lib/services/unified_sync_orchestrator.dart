...
class UnifiedSyncOrchestrator {
  ...
  Future<String> _computeUnifiedChecksum() async {
    ...
    final tablesPayload = <String, List<Map<String, dynamic>>>{
      'rooms': (results[0] as List).map((e) => (e as dynamic).toJson() as Map<String, dynamic>).toList(),
      'bookings': (results[1] as List).map((e) => (e as dynamic).toJson() as Map<String, dynamic>).toList(),
      'booking_notes': (results[2] as List).map((e) => (e as dynamic).toJson() as Map<String, dynamic>).toList(),
      'employees': (results[3] as List).map((e) => (e as dynamic).toJson() as Map<String, dynamic>).toList(),
      'expenses': (results[4] as List).map((e) => (e as dynamic).toJson() as Map<String, dynamic>).toList(),
      'cash_transactions': (results[5] as List).map((e) => (e as dynamic).toJson() as Map<String, dynamic>).toList(),
      'payments': (results[6] as List).map((e) => (e as dynamic).toJson() as Map<String, dynamic>).toList(),
      'debts': (results[7] as List).map((e) => (e as dynamic).toJson() as Map<String, dynamic>).toList(),
      'booking_nights': (results[8] as List).map((e) => (e as dynamic).toJson() as Map<String, dynamic>).toList(),
      'hotel_day_ledger': (results[9] as List).map((e) => (e as dynamic).toJson() as Map<String, dynamic>).toList(),
      'shift_notes': (results[10] as List).map((e) => (e as dynamic).toJson() as Map<String, dynamic>).toList(),
    };
