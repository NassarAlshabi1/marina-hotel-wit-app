...
class SyncGuard {
  ...
  /// الحد الأدنى للفاصل الزمني بين بدء مزامنتين من خدمات مختلفة.
  /// هذا يمنع التداخل المباشر، لكنه لا يمنع المزامنة المتسلسلة تماماً —
  /// الخدمة التالية يمكن أن تبدأ بعد فترة قصيرة من انتهاء السابقة.
