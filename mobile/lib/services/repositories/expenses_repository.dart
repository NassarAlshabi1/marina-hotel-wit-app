...
class ExpensesRepository {
  ...
  Future<int> createAutoGenerated({
    ...
    try {
      ...
      // ✅ (2026-09-19) إغلاق فجوة employee_uuid للسلف المقسطة/خصم الراتب:
      // الموظف معروف عبر relatedId — نكتب UUID فوراً عند الإنشاء.
      ...
      if (relatedId != null) {
        final employee =
            await (db.select(db.employees)
                  ...
                  ..limit(1))
                .getSingleOrNull();
        if (employee != null && employee.localUuid.isNotEmpty) {
