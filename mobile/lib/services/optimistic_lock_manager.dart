...
class OptimisticLockManager {
  ...
  Future<int?> _getCurrentVersion(String table, String uuid) async {
    ...
    try {
      ...
      AppLogger.error('خطأ في قراءة الإصدار: $e');
      return null;
    }
  }
  ...
  Future<void> _updateVersion(String table, String uuid, int newVersion) async {
    try {
      ...
      AppLogger.error('خطأ في تحديث الإصدار: $e');
      rethrow;
    }
  }
  ...
  Future<T> executeWithLock<T>({
    ...
    try {
      ...
      try {
        ...
        AppLogger.warning('Version rollback failed after optimistic lock conflict: $e');
      }
      rethrow;
    }
  }
