...
class AppwriteSyncUtils {
  ...
  static const Map<String, Set<String>> validFieldsPerCollection = {
    ...
    'payment_voids': {
      'approvedBy', 'bookingUuid', 'createdAt', 'deletedAt', 'deviceId',
      'hotelDayKey', 'lastModified', 'localUuid', 'note', 'origin',
      'originalAmount', 'originalPaymentId', 'originalPaymentUuid',
      'paymentUuid', 'reversalPaymentUuid', 'serverId', 'syncTimestamp',
      'updatedAt', 'vectorClock', 'version', 'voidedAmount', 'voidedAt',
