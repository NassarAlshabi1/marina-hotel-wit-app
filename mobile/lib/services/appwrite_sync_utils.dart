...
class AppwriteSyncUtils {
  ...
  static const Map<String, Set<String>> validFieldsPerCollection = {
    'rooms': {
      ...
      'deletedAt', 'deletedAtIso', 'deviceId', 'id', 'idempotencyKey',
      'imageUrl', 'lastCleanedHotelDay', 'lastModified', 'lastModifiedEpoch',
      'lastOccupiedHotelDay', 'localUuid', 'origin', 'price',
      'requiresMaintenance', 'roomNumber', 'roomType', 'serverId',
      'status', 'sync_origin', 'syncTimestamp', 'type', 'updatedAt',
    ...
    'expenses': {
      ...
      'deletedAtIso', 'description', 'deviceId', 'employeeUuid', 'expenseType',
      'hotelDayKey', 'id', 'idempotencyKey', 'isAutoGenerated', 'lastModified',
      'lastModifiedEpoch', 'localUuid', 'origin', 'relatedId', 'serverId',
    ...
    'debts': {
      'amount', 'bookingLocalId', 'checkinDate', 'checkoutDate', 'createdAt',
      'createdAtEpoch', 'createdAtIso', 'date', 'dateRecorded', 'debtReason',
      'debtUuid', 'deletedAt', 'deletedAtIso', 'description', 'deviceId',
      'guestName', 'guestPhone', 'hotelDayClosed', 'hotelDayOpened',
      'idempotencyKey', 'isFromAutoFix', 'isSettled', 'lastModified',
      'lastModifiedEpoch', 'localUuid', 'note', 'origin', 'paidAmount',
      'paymentDate', 'pledge', 'pledgeType', 'remainingAmount', 'serverId',
      'settlementConfirmed', 'status', 'sync_origin', 'syncTimestamp',
      'totalAmount', 'updatedAt', 'updatedAtIso', 'vectorClock', 'version',
      'id',
    },
    'booking_notes': {
      'alertType', 'alertUntil', 'bookingId', 'createdAt', 'createdAtEpoch',
      'createdAtIso', 'deletedAt', 'deletedAtIso', 'deviceId', 'id',
      'idempotencyKey', 'isActive', 'lastModified', 'lastModifiedEpoch',
      'localUuid', 'noteText', 'origin', 'serverId', 'sync_origin',
      'syncTimestamp', 'updatedAt', 'updatedAtIso', 'vectorClock', 'version',
    },
    'booking_nights': {
    ...
    'cash_transactions': {
      ...
      'deleted_at', 'deletedAt', 'deletedAtIso', 'description', 'device_id',
      'deviceId', 'id', 'idempotencyKey', 'last_modified', 'lastModified',
      'lastModifiedEpoch', 'localUuid', 'origin', 'referenceId',
      'referenceType', 'registerId', 'serverId', 'sync_origin',
      'sync_timestamp', 'syncTimestamp', 'transactionTime', 'transactionType',
      'updatedAt', 'updatedAtIso', 'vector_clock', 'vectorClock', 'version',
    },
    'shift_notes': {
      'content', 'created_at', 'createdAt', 'createdAtEpoch', 'createdAtIso',
      'createdBy', 'deleted_at', 'deletedAt', 'deletedAtIso', 'device_id',
      'deviceId', 'expiresAt', 'id', 'idempotencyKey', 'isRead',
      'last_modified', 'lastModified', 'lastModifiedEpoch', 'localUuid',
      'note', 'origin', 'priority', 'serverId', 'shiftDate', 'shiftType',
      'sync_origin', 'sync_timestamp', 'syncTimestamp', 'title', 'updatedAt',
      'updatedAtIso', 'updated_at', 'vector_clock', 'vectorClock', 'version',
    },
    'salary_cycles': {
    ...
    'salary_payments': {
      ...
      'deleted_at', 'deletedAt', 'deletedAtIso', 'device_id', 'deviceId',
      'hotelDayKey', 'id', 'idempotencyKey', 'isAutoGenerated',
      'last_modified', 'lastModified', 'lastModifiedEpoch', 'localUuid',
      'method', 'origin', 'paymentDateIso', 'serverId', 'sync_origin',
      'sync_timestamp', 'syncTimestamp', 'updatedAt', 'updatedAtIso',
      'vector_clock', 'vectorClock', 'version',
    },
    'salary_withdrawals': {
    ...
    'booking_price_adjustments': {
      'adjustmentMode', 'adjustmentType', 'amount', 'appliedAt', 'appliedBy',
      'bookingLocalId', 'bookingLocalUuid', 'bookingUuid', 'cancelledAt',
      'cancelledBy', 'createdAt', 'createdAtEpoch', 'createdAtIso',
      'deletedAt', 'deletedAtIso', 'deviceId', 'effectiveHotelDay',
      'endHotelDay', 'idempotencyKey', 'isActive', 'lastModified',
      'lastModifiedEpoch', 'localUuid', 'origin', 'reason', 'roomNumber',
    ...
    'payment_voids': {
      'approvedBy', 'bookingUuid', 'created_at', 'createdAt', 'createdAtEpoch',
      'createdAtIso', 'deleted_at', 'deletedAt', 'deletedAtIso', 'device_id',
      'deviceId', 'hotelDayKey', 'idempotencyKey', 'last_modified',
      'lastModified', 'lastModifiedEpoch', 'localUuid', 'note', 'origin',
      'originalAmount', 'originalPaymentId', 'originalPaymentUuid',
      'paymentUuid', 'reversalPaymentUuid', 'serverId', 'sync_origin',
      'sync_timestamp', 'syncTimestamp', 'updatedAt', 'updatedAtIso',
      'vector_clock', 'vectorClock', 'version', 'voidedAmount', 'voidedAt',
      'voidedAtIso', 'voidedBy', 'voidReason',
    },
    'guest_infos': {
      ...
      'origin', 'roomNumber', 'serverId', 'sync_origin', 'syncTimestamp',
      'updatedAt', 'updatedAtIso', 'vectorClock', 'version',
    },
    'blacklist': {
