...
class AppwriteSyncUtils {
  ...
  static const Map<String, Set<String>> validFieldsPerCollection = {
    'rooms': {
      ...
      'deletedAt', 'deletedAtIso', 'idempotencyKey', 'imageUrl',
    ...
    'expenses': {
      ...
      'deletedAtIso', 'description', 'expenseType', 'hotelDayKey',
    ...
    'debts': {
      ...
      'dateRecorded', 'debtReason', 'debtUuid', 'deletedAt', 'guestName',
      'hotelDayClosed', 'hotelDayOpened', 'isFromAutoFix', 'isSettled',
      'lastModified', 'localUuid', 'note', 'origin', 'paidAmount',
      'paymentDate', 'pledge', 'pledgeType', 'serverId',
      'settlementConfirmed', 'totalAmount', 'updatedAt',
    },
    'booking_notes': {
    ...
    'price_adjustments': {
      ...
      'deletedAt', 'deviceId', 'effectiveDate', 'hotelDayKey', 'isReversed',
      'lastModified', 'localUuid', 'newValue', 'origin', 'previousValue',
      'reason', 'reversedAt', 'reversedBy', 'roomNumber', 'serverId',
      'syncTimestamp', 'targetType', 'targetUuid', 'updatedAt', 'vectorClock',
      'version',
    },
    'booking_price_adjustments': {
      ...
      'createdAtEpoch', 'createdAtIso', 'deletedAt', 'deletedAtIso',
      'effectiveHotelDay', 'endHotelDay', 'isActive', 'lastModified',
      'lastModifiedEpoch', 'localUuid', 'origin', 'reason', 'serverId',
      'updatedAt', 'updatedAtIso', 'vectorClock', 'version',
    },
    'audit_logs': {
    ...
    'guest_infos': {
      ...
      'deletedAtIso', 'governorate', 'guestName', 'id', 'idempotencyKey',
      'idNumber', 'idType', 'issueDate', 'issuePlace', 'lastModified',
      'lastModifiedEpoch', 'localUuid', 'nationality', 'notes', 'origin',
      'roomNumber', 'serverId', 'updatedAt', 'updatedAtIso', 'vectorClock',
      'version',
    },
    'blacklist': {
