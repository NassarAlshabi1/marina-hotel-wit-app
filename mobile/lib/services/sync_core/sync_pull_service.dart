...
///
/// نسخة مُنظَّفة (v2) — تحتوي فقط على الدوال المستخدمة فعليًا من CloudflareSyncManager.
/// الدوال المُكررة (17 دالة _syncXxx + دوال المساعدة) محذوفة لأن CloudflareSyncManager
