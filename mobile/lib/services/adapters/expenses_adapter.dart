...
class ExpensesAdapter extends EntityAdapter<Expense, ExpensesCompanion> {
  ...
  @override
  ExpensesCompanion fromJson(Map<String, dynamic> json,
    ...
    return ExpensesCompanion(
      ...
      expenseType: _vStr(json, 'expenseType', src) ?? const d.Value.absent(),
      relatedId: _vInt(json, 'relatedId', src),
      description: _vStr(json, 'description', src) ?? const d.Value.absent(),
      amount: _vDouble(json, 'amount', src) ?? const d.Value(0.0),
      date: _vStr(json, 'date', src) ?? const d.Value(''),
      cashTransactionId: _vInt(json, 'cashTransactionId', src),
      hotelDayKey:
          _vStr(json, 'hotelDayKey', src) ?? _vStr(json, 'hotel_day_key', src),
      categoryUuid:
          _vStr(json, 'categoryUuid', src) ?? _vStr(json, 'category_uuid', src),
      cashFlowUuid: _vStr(json, 'cashFlowUuid', src) ??
          _vStr(json, 'cash_flow_uuid', src),
      isAutoGenerated:
          _vBool(json, 'isAutoGenerated', src) ?? const d.Value(false),
