...
class ExpensesAdapter extends EntityAdapter<Expense, ExpensesCompanion> {
  ...
  ExpensesCompanion fromJson(Map<String, dynamic> json, {required Source src, required ResolveResult refs}) {
    ...
    return ExpensesCompanion(
      ...
      categoryUuid: _vStr(json, 'categoryUuid', src) ?? _vStr(json, 'category_uuid', src),
      cashFlowUuid: _vStr(json, 'cashFlowUuid', src) ?? _vStr(json, 'cash_flow_uuid', src),
      isAutoGenerated: _vBool(json, 'isAutoGenerated', src) ?? const d.Value(false),
