...
class ExpensesAdapter extends EntityAdapter<Expense, ExpensesCompanion> {
  ...
  Map<String, dynamic> toJson(Expense model, {required Source src}) {
    return {
      ...
      _k(src, 'expenseType'): model.expenseType,
      _k(src, 'relatedId'): model.relatedId,
      _k(src, 'description'): model.description,
      _k(src, 'amount'): model.amount,
      _k(src, 'date'): model.date,
      _k(src, 'cashTransactionId'):
          model.cashTransactionId,
      _k(src, 'hotelDayKey'): model.hotelDayKey,
      _k(src, 'categoryUuid'): model.categoryUuid,
      _k(src, 'cashFlowUuid'): model.cashFlowUuid,
      _k(src, 'isAutoGenerated'): model.isAutoGenerated,
