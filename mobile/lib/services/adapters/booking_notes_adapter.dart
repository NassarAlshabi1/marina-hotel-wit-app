...
class BookingNotesAdapter
  ...
  Future<ResolveResult> resolveRefs(
    ...
    if (resolvedId == null && (bookingLocalId != null || bookingUuid != null)) {
      debugPrint(
        '[BookingNotesAdapter] Warning: Could not resolve booking for bookingLocalId: $bookingLocalId, uuid: $bookingUuid',
      );
    }
  ...
  BookingNotesCompanion fromJson(
    ...
    if (refs.bookingLocalId == null) {
      throw Exception('Cannot create BookingNote: bookingLocalId is null and could not be resolved.');
    }
