...
class PriceAdjustmentsAdapter
  ...
  @override
  String get collectionId => 'price_adjustments';

  @override
  String get drivePath => 'price_adjustments.json';
  ...
  PriceAdjustmentsCompanion fromJson(
    ...
    return PriceAdjustmentsCompanion(
      ...
      previousValue: _vDouble(json, 'previousValue', src, altKey: 'previous_value', fallback: 0.0),
      newValue: _vDouble(json, 'newValue', src, altKey: 'new_value', fallback: 0.0),
