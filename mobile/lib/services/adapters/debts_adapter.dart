...
class DebtsAdapter extends EntityAdapter<Debt, DebtsCompanion> {
  ...
  DebtsCompanion fromJson(
    ...
    return DebtsCompanion(
      ...
      totalAmount: _vIntMulti(json, ['totalAmount', 'total_amount'], src, fallback: 0),
      paidAmount: _vIntMulti(json, ['paidAmount', 'paid_amount'], src, fallback: 0),
      remainingAmount: _vIntMulti(json, ['remainingAmount', 'remaining_amount'], src, fallback: 0),
