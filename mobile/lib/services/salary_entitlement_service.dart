...
class SalaryEntitlementService {
  ...
  Future<SalaryEntitlement> calculateEmployeeEntitlement(
    ...
    for (final expense in expenses) {
      ...
      if (type == SalaryExpenseTypes.withdrawalLegacy || type == SalaryExpenseTypes.salary || type == SalaryExpenseTypes.withdrawal) {
        // ✅ سحب راتب مباشر
      ...
      } else if (type == SalaryExpenseTypes.advance) {
      ...
      } else if (type == SalaryExpenseTypes.deduction) {
      ...
      } else if (type == SalaryExpenseTypes.deductionLegacy || type == SalaryExpenseTypes.deductionGeneric || type == SalaryExpenseTypes.absence) {
        // خصوم حقيقية
        totalDeductions += expense.amount;
        transactions.add(
          SalaryTransaction(
