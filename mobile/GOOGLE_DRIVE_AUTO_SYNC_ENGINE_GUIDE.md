...
> **ملاحظة حول مصادر المزامنة:** الإصدار الحالي يسجل Backend واحداً (Google Drive) أثناء التهيئة ولا يدعم تبديله أثناء التشغيل، لذلك يتم الاستماع لتيار نتائج واحد ثابت. عند إضافة Backends إضافية أو خيار تبديل لاحقاً سنضيف آلية بث لتغيير الـBackend وإعادة الاشتراكات ديناميكياً.
