...
// تعيين عنوان الصفحة
$page_title = "التقارير المالية الشاملة";
?>
        ...
        <div class="col-md-3">
            <div class="card summary-card revenue-card">
                <div class="card-body text-center">
                    ...
                    <h3 class="amount-positive"><?= formatCurrency($total_revenue) ?></h3>
        ...
        <div class="col-md-3">
            <div class="card summary-card expense-card">
                <div class="card-body text-center">
                    ...
                    <h3 class="amount-negative"><?= formatCurrency($total_expenses) ?></h3>
        ...
        <div class="col-md-3">
            <div class="card summary-card withdrawal-card">
                <div class="card-body text-center">
                    ...
                    <h3 class="amount-warning"><?= formatCurrency($total_withdrawals) ?></h3>
                ...
                <tbody>
                    ...
                    <?php foreach ($revenues as $revenue): ?>
                        <tr>
                            ...
                            <td class="amount-positive"><?= formatCurrency($revenue['amount']) ?></td>
                ...
                <tbody>
                    ...
                    <?php foreach ($salary_withdrawals as $withdrawal): ?>
                        <tr>
                            ...
                            <td class="amount-warning"><?= formatCurrency($withdrawal['amount']) ?></td>
