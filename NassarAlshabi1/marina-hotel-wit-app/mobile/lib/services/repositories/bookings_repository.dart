...
class BookingsRepository {
  ...
  Future<int> create({
    ...
    AutoSyncEngine.instance.notifyDataChange(table: 'bookings', operation: 'INSERT', count: 1);
    return result;
  }
  ...
  Future<int> update(int id, {
    ...
    if (result > 0) {
      AutoSyncEngine.instance.notifyDataChange(table: 'bookings', operation: 'UPDATE', count: 1);
    }
    return result;
  }
  ...
  Future<int> delete(int id) async {
    ...
    if (result > 0) {
      AutoSyncEngine.instance.notifyDataChange(table: 'bookings', operation: 'DELETE', count: 1);
    }
    return result;
  }
