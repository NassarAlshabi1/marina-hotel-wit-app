...
const collections = [
  ...
  },
  {
    ...
    attributes: [
      ...
      { key: "lastModifiedEpoch", type: "integer" },
      { key: "version", type: "integer", default: 1 },
      { key: "origin", type: "string", size: 64 },
      { key: "vectorClock", type: "string", size: 64 },
      { key: "deviceId", type: "string", size: 100 },
      { key: "syncTimestamp", type: "integer" },
      { key: "sync_origin", type: "string", size: 64 },
      { key: "idempotencyKey", type: "string", size: 255 },
    ],
  },
  {
    id: "expenses",
